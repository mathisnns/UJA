    ...
    <section class="py-5 text-center container" id="text" style="margin-top: 0 !important; padding-top: 0px !important; padding-bottom: 0px !important;">
        <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
                <h3 class="fw-light">Bienvenue <?php echo $name; ?> !</h3>
                <p class="lead text-muted">Sur ce site, tu pourras trouver un trombinoscope de l'équipe de l'unité pour mieux les connaitre, accéder à un groupe de discussion, et même à un système de vote pour élire le film de la soirée !</p>
            </div>
        </div>

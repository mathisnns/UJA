  ...
  <section class="py-5 text-center container" id="text" style="margin-top: 0 !important; padding-top: 0px !important;">
    <div class="row py-lg-5" style="margin-bottom: 0;">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h2 class="fw-light">Wow ! Doucement cowboy !</h2>
        <p class="lead text-muted">Vous avez deja voter pour un film aujourdhui, vous devez attendre demain que le classement soit remis a zero. 
        </p>
      </div>
    </div>

  ...
  <section class="py-5 text-center container" id="text" style="margin-top: 0 !important; padding-top: 0px !important;">
    <div class="row py-lg-5" style="margin-bottom: 0;">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Felicitation !</h1>
        <p class="lead text-muted">vous venez de vous creer un compte, à partir de maintenant tu peut acceder a lensemble du site ! 
        </p>
      </div>
    </div>
